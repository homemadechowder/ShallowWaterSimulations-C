 ...
 *
 * _coder_ShallowWaterModel_api.h
 *
 * Code generation for function '_coder_ShallowWaterModel_api'
 *
 */

#ifndef _CODER_SHALLOWWATERMODEL_API_H
#define _CODER_SHALLOWWATERMODEL_API_H
...
extern void ShallowWaterModel_atexit(void);
extern void ShallowWaterModel_initialize(void);
extern void ShallowWaterModel_terminate(void);
extern void ShallowWaterModel_xil_shutdown(void);
extern void ShallowWaterModel_xil_terminate(void);

#endif

/* End of code generation (_coder_ShallowWaterModel_api.h) */
