...
#include "_coder_GaussianFcn_mex.h"
...
void GaussianFcn_atexit(void)
{
  ...
  GaussianFcn_xil_terminate();
  GaussianFcn_xil_shutdown();
...
void GaussianFcn_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_GaussianFcn_api.c) */
